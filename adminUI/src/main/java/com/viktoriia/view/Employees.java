...
public class Employees extends VerticalLayout {
	...
	public Employees() {
		...
		Tab addEmployee = new Tab(VaadinIcon.USERS.create(), new RouterLink("Create Employee", AddEmployee.class));
		...
		HorizontalLayout header = new HorizontalLayout(drawer, title, addEmployee, home, exit);
		header.expand(title);
